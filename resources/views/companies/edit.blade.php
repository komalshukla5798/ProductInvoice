...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('global.company') }}
    </div>
           ...
           <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
            ...
            <div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
             ...
             <div class="form-group logo {{ $errors->has('logo') ? 'has-error' : '' }}">
                ...
                @endif
                <a data-fancybox href="{{ $company->logo ?? '' }}"><img src="{{ $company->logo ?? '' }}" height="100" width="100" class="img-thumbnail" id="logo-display"></a>
            </div>

            <div class="form-group {{ $errors->has('website') ? 'has-error' : '' }}">
                <label for="website">{{ trans('global.website') }}</label>
                <input type="url" id="website" name="website" class="form-control" value="{{ old('website', isset($company) ? $company->website : '') }}">
